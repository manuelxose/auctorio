...
## Summary
- 3646 nodes · 8250 edges · 170 communities (152 shown, 18 thin omitted)
...
Cohesion: 0.03
Nodes (58): AutomationStatus, ConfigSchemaField, ConnectorAuthMethodView, ConnectorCapabilitiesResponse, ConnectorView, CreateProjectPayload, CreateSitePayload, DiscoveredDomain (+50 more)

### Community 1 - "routes.ts"
Cohesion: 0.05
Nodes (81): getContentTypeFromPath(), MIME_BY_EXTENSION, assignStudioRoleToUser(), buildApiKeyStudioSession(), createStudioRole(), ensureTenantBootstrap(), getInternalStudioIdentityProviderBySlug(), getInternalStudioWorkspaceAccessBySlug() (+73 more)
...
Cohesion: 0.13
Nodes (26): acceptStudioInvitation(), completeLocalAccountLogin(), consumeStudioAccountToken(), getStudioAccountByEmail(), getStudioAccountByGoogleSubject(), getStudioLoginOptions(), getStudioRequestAccessUrl(), hasEnabledProvider() (+18 more)

### Community 8 - "routes-discovery.ts"
Cohesion: 0.09
Nodes (44): eventHeartbeatMs(), eventRateLimitPerMinute(), getPublisher(), parseEvent(), publishEvent(), readEventsSince(), sanitizeEventPayload(), streamKey() (+36 more)

### Community 9 - "routes-editorial.ts"
Cohesion: 0.06
Nodes (77): listAudit(), writeAudit(), pauseAutomation(), resumeAutomation(), updatePolicy(), CalendarFilters, listCalendarEvents(), prisma (+69 more)
...
Cohesion: 0.11
Nodes (40): ConnectionDependencies, ConnectionJobData, defaultDependencies, prisma, processConnectionJob(), runDiscovery(), runVerification(), assertCanTransition() (+32 more)
...
Cohesion: 0.09
Nodes (35): runAutomationWorker(), AUTOMATION_DEFAULTS, AutomationStatus, countChannelPublicationsToday(), EditorialSlot, generateEditorialSlots(), getAutomationStatus(), getChannelWindow() (+27 more)
...
### Community 19 - "sha256"
Cohesion: 0.10
Nodes (20): sha256(), authPlugin(), buildServer(), startServer(), createFixture(), createTenant(), createTenant(), createFixture() (+12 more)
...
Cohesion: 0.11
Nodes (15): MockTextProvider, OpenAICompatibleTextProvider, TextGenerationInput, TextGenerationResult, TextProvider, TextUsage, arr(), enums() (+7 more)
...
Cohesion: 0.15
Nodes (21): getImageProvider(), isProductionEnv(), buildOAuthHeader(), dryRunResult(), igUrl(), InstagramCredentials, InstagramPublisherAdapterImpl, isDryRunEnabled() (+13 more)

### Community 32 - "operations.ts"
Cohesion: 0.14
Nodes (27): completeOperationForJob(), failOperationForJob(), JobDataWithOperation, markOperationStartedForJob(), runConnectionWorker(), isOneOf(), isUuid(), parsePage() (+19 more)
...
Cohesion: 0.06
Nodes (51): Args, cleanupAccount(), cleanupInstallationDrafts(), main(), parseArgs(), prisma, reportCandidates(), resolveTargets() (+43 more)
...
Cohesion: 0.16
Nodes (10): EditorialPlanningContext, PlanningEvidence, PlanningStrategy, prisma, EditorialPlanBriefV2, SiteIntelligenceProfileSummary, DEFAULT_RELEVANCE_THRESHOLD, existing (+2 more)
...
Cohesion: 0.26
Nodes (13): enqueueConnectionJob(), enqueueImageJob(), enqueuePublishingJob(), enqueueScrapingJob(), enqueueSocialJob(), enqueueTextJob(), getPublishingQueue(), getQueue() (+5 more)
...
### Community 49 - "worker-discovery.ts"
Cohesion: 0.24
...
Cohesion: 0.23
Nodes (14): SearchIntent, CannibalizationVerdict, classifyCannibalization(), computeSiteRelevanceScore(), intentFitsProfile(), knownPlatformFromText(), normalize(), OFF_TOPIC_TERMS (+6 more)

### Community 53 - "repository.ts"
Cohesion: 0.08
Nodes (40): asRecord(), buildDerivatives(), deriveVersion(), makeDerivative(), prisma, readNumber(), readString(), stripHtml() (+32 more)
...
Cohesion: 0.14
Nodes (21): normalizeText(), assertSafeAutomationPolicy(), assignSourceItemToCluster(), buildSemanticHash(), clampScore(), CoverageCheckResult, overlapRatio(), prisma (+13 more)

### Community 61 - "crypto.ts"
Cohesion: 0.21
Nodes (10): decryptSecret(), encryptionKey(), encryptSecret(), generateOAuthState(), generatePkceVerifier(), hmacHex(), tryDecryptSecret(), loadActiveInstallationForSite() (+2 more)
...
Cohesion: 0.12
Nodes (21): loadBlockedDomainSet(), recommendSource(), upsertDiscoveredDomain(), upsertSourceItem(), DailyUsage, dedupeCandidates(), DiscoveryRunResult, ensureDomainSource() (+13 more)
...
### Community 74 - "resolveTenantBySlug"
Cohesion: 0.26
Nodes (9): main(), WORKSPACE_BOOTSTRAP, main(), ensureUniqueTenantSlug(), getFirstPartyLaunchWorkspaceSet(), resolveTenantBySlug(), hashStudioPassword(), scryptAsync() (+1 more)

### Community 75 - "notifications.ts"
Cohesion: 0.20
Nodes (17): parseBody(), archiveNotification(), getNotificationPreferences(), listNotifications(), markAllNotificationsRead(), markNotificationRead(), NotificationCategory, NotificationInput (+9 more)
...
Cohesion: 0.11
Nodes (24): getTextProvider(), buildPlanPrompt(), DiscoveryQueryPlan, EditorialDiscoveryContext, gatherEditorialContext(), parseDiscoveryPlan(), planDiscovery(), prisma (+16 more)
...
### Community 87 - "completeGlobalAccountLogin"
Cohesion: 0.33
Nodes (7): buildHumanSession(), buildPermissionList(), buildRoleKeyList(), completeGlobalAccountLogin(), readTenantSessionContext(), resolveTenantSlugForSession(), roleFromKeys()
...
### Community 90 - "getNumberEnv"
Cohesion: 0.16
Nodes (7): runSchedulerTick(), runSchedulerWorker(), getNumberEnv(), claimDuePublications(), FirecrawlWebIntelligenceProvider, normalizeSearchItem(), TavilyWebIntelligenceProvider
...
Cohesion: 0.08
Nodes (38): AccountWithMemberships, ensureStudioRoles(), ensureUniqueRoleKey(), GlobalSiteSession, GlobalStudioLoginResult, prisma, toPrismaJsonObject(), UserWithRoles (+30 more)

### Community 119 - "completeStudioSsoLogin"
Cohesion: 0.16
Nodes (21): applyMappedRoles(), completeStudioSsoLogin(), createStudioLaunchTicket(), createStudioUserSession(), ensureRolesByKeys(), ensureStudioAccountByEmail(), extractMappedRoleKeys(), inviteStudioUser() (+13 more)
...
Cohesion: 0.12
Nodes (18): AuditActorType, AuditEntryInput, prisma, archiveProject(), ArchiveProjectInput, ArchiveProjectResult, enqueueUnpublishForWebsite(), prisma (+10 more)
...
- **Why does `getNumberEnv()` connect `getNumberEnv` to `scraping/index.ts`, `routes-discovery.ts`, `prisma.ts`, `planner.ts`, `structured-output.test.ts`, `social-provider.ts`, `social-publishers.ts`, `operations.ts`, `crawler.ts`, `getPrismaClient`, `publication.ts`, `topic-controller.ts`, `verification.ts`, `profile.ts`, `producer.ts`, `sources.ts`, `worker-discovery.ts`, `editorial.ts`, `publishers.ts`, `social-connections.ts`, `getEnv`, `web-discovery.ts`, `image.ts`, `deps.ts`, `structured.ts`, `fetchWithTimeout`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `StudioApiService` connect `StudioApiService` to `studio.models.ts`, `app.routes.ts`, `ContentWorkspacePageComponent`, `SourcesPageComponent`, `SiteIntelligencePageComponent`, `InboxPageComponent`, `CalendarPageComponent`, `PublishingPageComponent`, `MediaPageComponent`, `ConnectionsPageComponent`, `SettingsPageComponent`, `SseService`, `StudioPublication`, `ActivityPageComponent`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `getEnv()` connect `getEnv` to `routes.ts`, `scraping/index.ts`, `loginStudioAccountWithPassword`, `routes-discovery.ts`, `worker-publishing.ts`, `planner.ts`, `sha256`, `structured-output.test.ts`, `social-provider.ts`, `social-publishers.ts`, `getPrismaClient`, `producer.ts`, `sources.ts`, `worker-discovery.ts`, `crypto.ts`, `publishers.ts`, `social-connections.ts`, `web-discovery.ts`, `image.ts`, `registry.ts`, `resolveTenantBySlug`, `social.ts`, `structured.ts`, `fetchWithTimeout`, `getNumberEnv`, `studio/auth.ts`, `completeStudioSsoLogin`?**
...
- **Should `studio.models.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.0292192613370734 - nodes in this community are weakly interconnected._
