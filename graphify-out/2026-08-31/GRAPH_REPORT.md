# Graph Report - auctorio  (2026-08-31)

## Corpus Check
- 417 files · ~352,118 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4712 nodes · 11198 edges · 218 communities (177 shown, 41 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 38 edges (avg confidence: 0.84)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4d7153d1`
...
1. `StudioApiService` - 190 edges
2. `getNumberEnv()` - 119 edges
3. `getEnv()` - 112 edges
4. `registerStudioRoutes()` - 112 edges
5. `getPrismaClient()` - 108 edges
6. `writeAudit()` - 82 edges
7. `ContentWorkspacePageComponent` - 71 edges
8. `"tenants"` - 69 edges
9. `registerEditorialRoutes()` - 69 edges
10. `SourcesPageComponent` - 58 edges
...
- `createTenant()` --calls--> `sha256()`  [EXTRACTED]
  tests/operations.test.ts → src/shared/utils/hash.ts
- `makeItem()` --calls--> `emptyDiscoveredItem()`  [EXTRACTED]
  tests/content-intelligence.test.ts → src/studio/adapters/normalize.ts
- `makeItem()` --calls--> `emptyDiscoveredItem()`  [EXTRACTED]
  tests/editorial-engine.test.ts → src/studio/adapters/normalize.ts
- `makeItem()` --calls--> `emptyDiscoveredItem()`  [EXTRACTED]
...
## Communities (218 total, 41 thin omitted)

### Community 0 - "studio.models.ts"
Cohesion: 0.03
Nodes (64): AutomationStatus, BlockedDomain, ConfigSchemaField, ConnectorAuthMethodView, ConnectorCapabilitiesResponse, ConnectorView, CreateProjectPayload, CreateSitePayload (+56 more)

### Community 1 - "app.routes.ts"
Cohesion: 0.07
Nodes (44): AppEmptyStateComponent, Component, AppIconComponent, IconElement, ICONS, StudioIconName, Component, studioAuthGuard() (+36 more)

### Community 2 - "studio/auth.ts"
Cohesion: 0.05
Nodes (86): main(), WORKSPACE_BOOTSTRAP, AccountWithMemberships, applyMappedRoles(), assignStudioRoleToUser(), buildApiKeyStudioSession(), buildHumanSession(), buildPermissionList() (+78 more)

### Community 3 - "getNumberEnv"
Cohesion: 0.12
Nodes (15): getNumberEnv(), buildDryRunResult(), GenericRestPublisher, GenericWebhookPublisher, getDryRunDecision(), GuiaTvPublisher, readCredentialRef(), readJsonCredentials() (+7 more)

### Community 4 - "routes.ts"
Cohesion: 0.07
Nodes (42): getContentTypeFromPath(), MIME_BY_EXTENSION, listStudioUsers(), mapUserSummary(), updateStudioUser(), parseJsonObjectField(), STUDIO_PERMISSIONS_HEADER, STUDIO_SESSION_HEADER (+34 more)
...
### Community 7 - "StudioApiService"
Cohesion: 0.02
Nodes (16): AutomationPolicy, NotificationPreference, SocialConnectionSession, StudioEditorialProfile, StudioEnrichmentProvider, StudioIntelligenceSettings, StudioMuteRule, StudioSession (+8 more)

### Community 8 - "web-discovery.ts"
Cohesion: 0.06
Nodes (52): getDiscoveryMetrics(), prisma, registerDiscoveryRoutes(), acceptSourceRecommendation(), applySourceFeedback(), AUTHORITY_TLDS, blockDomain(), detectSpamSignals() (+44 more)

### Community 9 - "routes-editorial.ts"
Cohesion: 0.07
Nodes (57): listAudit(), writeAudit(), pauseAutomation(), resumeAutomation(), CalendarFilters, listCalendarEvents(), prisma, listStoryClusters() (+49 more)

### Community 10 - "structured.ts"
Cohesion: 0.08
Nodes (30): balanceJson(), extractJsonCandidate(), generateStructured(), parseJsonWithRepair(), repairJson(), stripFences(), StructuredGenerationAttempt, StructuredGenerationOptions (+22 more)

### Community 11 - "intelligence-phase3.test.ts"
Cohesion: 0.07
Nodes (44): setMovieTvProviderEngine(), CANDIDATE_WEIGHTS, CandidateComponentKey, CandidateScoreInput, CandidateScoreResult, clamp01(), scoreCandidate(), ScoreComponent (+36 more)

### Community 12 - "site-relevance.ts"
Cohesion: 0.11
Nodes (27): buildEditorialPlanningContext(), EditorialPlanningContext, loadProfile(), PlanningEvidence, PlanningStrategy, prisma, postValidatePlanItems(), EditorialPlanBriefV2 (+19 more)
...
### Community 14 - "connectors/registry.ts"
Cohesion: 0.12
...
### Community 15 - "EditorialPlanPageComponent"
Cohesion: 0.06
Nodes (3): EditorialPlan, EditorialPlanPageComponent, Component

### Community 16 - ""tenants""
Cohesion: 0.06
Nodes (74): "ai_audit", "content_image", "content_text", "facts", "jobs", "tenants", "topics", "asset_variants" (+66 more)

### Community 17 - "routes-connectors.ts"
Cohesion: 0.14
Nodes (29): assertCanTransition(), cancelInstallation(), canTransition(), clearInstallationCredentials(), createInstallation(), deleteInstallationDraft(), getInstallation(), INSTALLATION_STATES (+21 more)

### Community 18 - "getPrismaClient"
Cohesion: 0.08
Nodes (43): hashApiKey(), main(), main(), ROLE_KEYS, main(), hashApiKey(), main(), allowedStatuses (+35 more)

### Community 19 - "AppShellComponent"
Cohesion: 0.06
...
### Community 21 - "enrichment-providers.ts"
Cohesion: 0.24
Nodes (10): SourceHttpError, CreateEnrichmentProviderInput, credentialsConfigured(), getEnrichmentProvider(), listEnrichmentProviders(), prisma, redactConfiguration(), resolveCredentials() (+2 more)

### Community 22 - "4. Componentes"
Cohesion: 0.05
...
### Community 23 - "Auctorio — Milestones"
Cohesion: 0.05
Nodes (39): Auctorio — Milestones, Known non-blocking residuals, Known non-blocking residuals (unchanged), M0 — Repository Intelligence ✅, M10 — Golden Path ✅ (GuiaTV) / ✅ (Tecnoria — 2026-08-25), M11 — Cross-Tenant Regression 🟡, M12 — UX/UI Enterprise Rebuild ✅, M13 — Realtime, Reliability, Observability 🟡 (+31 more)

### Community 25 - "dependencies.ts"
Cohesion: 0.25
...
### Community 26 - "pipeline.ts"
Cohesion: 0.07
Nodes (46): DiscoveryTickResult, prisma, runDiscoveryTick(), runDiscoveryWorker(), scoreAndClusterItems(), listDomainPlugins(), normalizePrecedence(), ProviderPrecedence (+38 more)

### Community 27 - "Auctorio Design System"
Cohesion: 0.06
...
### Community 29 - "Auctorio Admin Redesign"
Cohesion: 0.06
...
### Community 30 - "Auctorio Product Architecture"
Cohesion: 0.06
...
### Community 31 - "topic-controller.ts"
Cohesion: 0.16
...
### Community 32 - "api.ts"
Cohesion: 0.12
Nodes (39): fetchHtmlWithBrowser(), ApiAdapter, parseApiItems(), readField(), resolvePath(), AtomAdapter, GraphqlAdapter, HtmlAdapter (+31 more)

### Community 33 - "AppConfirmDialogComponent"
Cohesion: 0.11
Nodes (11): App, appConfig, config, serverConfig, routes, serverRoutes, Component, AppConfirmDialogComponent (+3 more)

### Community 34 - "StudioPublication"
Cohesion: 0.11
Nodes (5): PublicationChannel, PublicationState, StudioPublication, PublicationsPageComponent, Component

### Community 35 - "Talkaris Admin Redesign"
Cohesion: 0.06
...
### Community 36 - "marketing-content.ts"
Cohesion: 0.07
...
### Community 37 - "scraping/index.ts"
Cohesion: 0.07
Nodes (54): buildContentFromFields(), compactWhitespace(), enforceRateLimit(), ensureRobotsAllowed(), extractLink(), extractSelectors(), fetchUrl(), getRobotsRules() (+46 more)

### Community 38 - "repositories.ts"
Cohesion: 0.09
Nodes (22): AiAudit, ContentStatus, ContentTextType, Fact, FactSourceType, Job, JobStatus, JobType (+14 more)

### Community 39 - "CalendarPageComponent"
Cohesion: 0.11
Nodes (3): CalendarEvent, CalendarPageComponent, Component

### Community 40 - "ConnectionsPageComponent"
Cohesion: 0.09
Nodes (6): ConnectorInstallation, ConnectorKind, SocialConnection, SocialSetupInfo, ConnectionsPageComponent, Component

### Community 41 - "publishers.ts"
Cohesion: 0.08
Nodes (27): loadActiveInstallationForSite(), ALLOWED_ATTRIBUTES, ALLOWED_TAGS, sanitizeEditorialHtml(), asRecord(), buildDryRunExternalId(), buildGuiaTvPayload(), DryRunDecision (+19 more)

### Community 42 - "loginStudioAccountWithPassword"
Cohesion: 0.11
...
### Community 44 - "SourcesPageComponent"
Cohesion: 0.08
Nodes (5): SourceRecommendation, StudioFeedCandidate, StudioSource, SourcesPageComponent, Component

### Community 45 - "http-utils.ts"
Cohesion: 0.09
Nodes (53): listAdapterTypes(), getMovieTvProviderEngine(), listGenerations(), getImdbProvider(), getOmdbProvider(), createEnrichmentProvider(), deleteEnrichmentProvider(), updateEnrichmentProvider() (+45 more)

### Community 46 - "fetchWithTimeout"
Cohesion: 0.06
...
### Community 48 - "EditorialEnginePageComponent"
Cohesion: 0.11
...
### Community 50 - "social-publishers.ts"
Cohesion: 0.12
Nodes (30): loadPublication(), processPublish(), processUnpublish(), startAttempt(), succeedAttempt(), resolveAccountCredentials(), verifyLegacyAccount(), buildDryRunResult() (+22 more)
...
### Community 52 - "2. Mapa objetivo de rutas"
Cohesion: 0.08
...
### Community 53 - "editorial-engine.test.ts"
Cohesion: 0.10
Nodes (25): setClassifierOverride(), buildFactLicenses(), buildFactSafetyReport(), CONFLICT_SENSITIVE_KEYS, COPYRIGHT_CUES, FactSafetyContext, FactSafetyReport, HIGH_SENSITIVITY_FACT_KEYS (+17 more)

### Community 54 - "provider-cache.ts"
Cohesion: 0.08
Nodes (29): EnrichmentProviderAdapter, DEFAULT_PROVIDER_PRECEDENCE, EnrichmentCategory, EnrichmentOutcome, prisma, ProviderEngine, ProviderEngineContext, ttlForCategory() (+21 more)
...
### Community 56 - "InboxPageComponent"
Cohesion: 0.11
Nodes (4): SourceItemStatus, StudioSourceItem, InboxPageComponent, Component

### Community 57 - "writer-prompt.ts"
Cohesion: 0.10
Nodes (25): renderBriefForWriter(), renderStructureLines(), ATTRIBUTION, CONCLUSION, CONTEXT, LEAD_INVERTED_PYRAMID, renderStructureSpec(), STRUCTURE_SPECS (+17 more)
...
### Community 60 - "AUCTORIO MASTER ROADMAP"
Cohesion: 0.05
...
Cohesion: 0.09
Nodes (23): @angular/build, @angular/cli, devDependencies, @angular/build, @angular/cli, jasmine-core, karma, karma-coverage (+15 more)
...
### Community 66 - "worker-publishing.ts"
Cohesion: 0.20
...
### Community 69 - "AutomationPageComponent"
Cohesion: 0.10
Nodes (6): PublicationListItem, PublishingAccount, AutomationPageComponent, Component, PublishingPageComponent, Component

### Community 70 - "scripts"
Cohesion: 0.09
Nodes (23): scripts, bootstrap:studio-access, build, build:studio, dev:studio, report:editorial-engine, report:intelligence, serve:studio (+15 more)
...
### Community 72 - "tmdb.ts"
Cohesion: 0.09
Nodes (19): EnrichmentLookupInput, EnrichmentLookupResult, EnrichmentPayload, providerGetJson(), ProviderRateLimitedError, ProviderUnavailableError, yearFromDate(), IMDB_PROVIDER_KEY (+11 more)

### Community 73 - "source-registry.test.ts"
Cohesion: 0.11
Nodes (46): validateScrapeUrl(), categoryValues(), extractAtomAlternateLink(), extractAtomAuthors(), parseAtomItems(), extractJsonLd(), jsonLdField(), parseHtmlArticle() (+38 more)

### Community 74 - "AUCTORIO REBUILD STATUS"
Cohesion: 0.11
...
### Community 76 - "movie-tv/plugin.ts"
Cohesion: 0.10
Nodes (27): normalizeText(), cleanWorkTitle(), detectWorkType(), extractSeasonFromTitle(), extractYearFromTitle(), matchWork(), MatchWorkInput, MOVIE_CUES (+19 more)

### Community 77 - "development"
Cohesion: 0.22
Nodes (9): build, builder, configurations, defaultConfiguration, development, buildTarget, extractLicenses, optimization (+1 more)

### Community 78 - "options"
Cohesion: 0.15
...
Cohesion: 0.15
Nodes (23): getClassifiedStory(), decideCreateUpdateOrSkip(), DuplicateCheckInput, DuplicateCheckResult, prisma, sharesPrimaryEntity(), hasCopyrightWarningCues(), asRecord() (+15 more)

### Community 82 - "content-intelligence.test.ts"
Cohesion: 0.09
Nodes (26): BreakerEntry, CircuitBreaker, CircuitBreakerOptions, CircuitState, DEFAULT_OPTIONS, resolveBreakerOptions(), computeBackoffDelayMs(), DEFAULT_RETRY_OPTIONS (+18 more)

### Community 84 - "deps.ts"
Cohesion: 0.17
Nodes (6): ContentImage, CostPolicy, CostPolicyResult, JobQueue, ContentImageRepository, UseCaseDependencies

### Community 85 - "editorial.ts"
Cohesion: 0.07
Nodes (39): assignSourceItemToCluster(), buildSemanticHash(), clamp01(), clampScore(), CLUSTER_SIMILARITY_THRESHOLD, CLUSTER_WINDOW_HOURS, ClusterAssignment, ClusterMember (+31 more)
...
### Community 87 - "Auctorio Studio — Design System (Phase 2)"
Cohesion: 0.13
...
### Community 88 - "SiteIntelligencePageComponent"
Cohesion: 0.26
Nodes (3): SiteIntelligenceOverview, SiteIntelligencePageComponent, Component

### Community 89 - "1. Universal connection installer"
Cohesion: 0.14
...
### Community 90 - "3. Architecture decisions"
Cohesion: 0.14
...
### Community 91 - "Auctorio — Universal Connection Installer, Job Center, Notifications and UX Polish"
Cohesion: 0.14
...
### Community 92 - "sources.ts"
Cohesion: 0.08
Nodes (35): ListingSourceConfig, ImdbDatasetOptions, parseImdbTsvLines(), readTailLines(), buildItemContentHash(), buildNormalizedTitleHash(), normalizeTitleForFingerprint(), getSourceAdapter() (+27 more)

### Community 93 - "extraction.ts"
Cohesion: 0.14
Nodes (19): movieTvEntityKey(), classifyCapitalizedPhrase(), collectPhrases(), extractEntitiesFromText(), extractionCanonicalKey(), ExtractionInput, ExtractionOptions, extractQuotedWorks() (+11 more)
...
### Community 98 - "repository.ts"
Cohesion: 0.07
Nodes (49): asRecord(), buildDerivatives(), deriveVersion(), makeDerivative(), prisma, readNumber(), readString(), requestImageGenerationForVersion() (+41 more)

### Community 99 - "Auctorio Studio — Frontend Rebuild Audit (Phase 0)"
Cohesion: 0.17
...
### Community 100 - "deduplication.ts"
Cohesion: 0.20
Nodes (11): classifyMatch(), DedupInput, DedupOptions, DedupReason, DedupResult, DEFAULT_DEDUP_OPTIONS, evaluateDedup(), ExistingItem (+3 more)

### Community 101 - "limiter.ts"
Cohesion: 0.12
...
### Community 102 - "getEnv"
Cohesion: 0.13
Nodes (22): ApiEnvelope, assert(), call(), main(), PostShape, getImageProvider(), getBooleanEnv(), getEnv() (+14 more)

### Community 103 - "verify-platform-credentials.ts"
Cohesion: 0.27
Nodes (11): Account, checkAuctorioLogin(), checkAuthEndpoint(), checkPublicSite(), CheckResult, Inventory, jsonRequest(), main() (+3 more)

### Community 104 - "studio-web"
Cohesion: 0.33
Nodes (6): studio-web, prefix, projectType, root, schematics, sourceRoot

### Community 105 - "CLAUDE.md - Auctorio Agent Guide"
Cohesion: 0.17
...
### Community 106 - "Studio Simplification — Architecture Report"
Cohesion: 0.18
...
### Community 107 - "Studio Simplification — Deletion Report"
Cohesion: 0.18
...
### Community 108 - "Talkaris Screen Map"
Cohesion: 0.18
...
### Community 109 - "Content AI Platform — Auctorio"
Cohesion: 0.18
...
### Community 110 - "source-registry.ts"
Cohesion: 0.12
Nodes (22): main(), MatrixRow, pad(), buildProvenance(), ProvenanceRecord, MOVIE_TV_EN_PACK, EnrichmentProviderSeed, SourcePackDefinition (+14 more)

### Community 111 - "AuctorioChatWidgetComponent"
Cohesion: 0.29
Nodes (4): AuctorioChatWidgetComponent, Component, Input, Inject

### Community 112 - "SseService"
Cohesion: 0.30
Nodes (4): StudioEventMessage, EventListener, SseService, Injectable

### Community 114 - "connectors/verification.ts"
Cohesion: 0.13
...
### Community 116 - "Auctorio SEO Engine V2 — Architecture & Operator Notes (M16–M22)"
Cohesion: 0.22
...
### Community 117 - "Auctorio Studio — Frontend Information Architecture (Phase 1)"
Cohesion: 0.22
...
### Community 124 - "Studio Web"
Cohesion: 0.25
Nodes (7): Comandos, Flujo soportado, Notas operativas, Que hace, Rutas principales, Studio Web, Variables necesarias

### Community 125 - "provision-linked-tenants.ts"
Cohesion: 0.39
Nodes (7): asJson(), FIXTURE_SITES, hashApiKey(), main(), parseArgs(), provision(), ProvisionArgs

### Community 126 - "InMemoryResilienceStore"
Cohesion: 0.16
Nodes (4): Entry, InMemoryResilienceStore, ResilienceStore, sharedStore

### Community 127 - "brief-builder.ts"
Cohesion: 0.14
Nodes (20): BriefInput, buildStoryBrief(), derivePrimaryKeyword(), deriveSecondaryKeywords(), STORY_ANGLE_BY_TYPE, stripPunctuation(), titleCaseStops(), ClassificationInput (+12 more)

### Community 128 - "editorial-qa.ts"
Cohesion: 0.15
Nodes (20): addFinding(), DATE_PATTERN, DimensionAccumulator, extractDates(), extractYears(), NAME_STOPWORDS, NEWS_TYPES, normalize() (+12 more)

### Community 129 - "editorial-engine/types.ts"
Cohesion: 0.13
Nodes (18): DEFAULT_PUBLICATION_GATES, evaluatePublicationGates(), GatesInput, resolveGatesConfig(), ARTICLE_TYPES, EditorialQaReport, FactLedgerView, PublicationDecision (+10 more)

### Community 130 - "Auctorio → GuiaTV Production Acceptance Evidence"
Cohesion: 0.29
...
### Community 131 - "Auctorio Environment & Configuration Audit"
Cohesion: 0.29
...
### Community 134 - "operations.ts"
Cohesion: 0.09
Nodes (47): getRedisConnectionOptions(), RedisConnectionOptions, markOperationStartedForJob(), ConnectionDependencies, ConnectionJobData, defaultDependencies, prisma, processConnectionJob() (+39 more)

### Community 135 - "writer-provider.ts"
Cohesion: 0.15
Nodes (13): ParsedArticle, ArticleWriter, ArticleWriterFactory, DefaultArticleWriter, WriterGenerationInput, WriterGenerationResult, buildFakeArticleFromPrompt(), extractFactsFromPrompt() (+5 more)

### Community 137 - "public-shell.component.ts"
Cohesion: 0.18
...
### Community 138 - "seo-package.ts"
Cohesion: 0.29
Nodes (12): buildMetaDescription(), buildSeoPackage(), buildSeoTitle(), countOccurrences(), normalizeForMatch(), SeoInput, slugify(), stripHtml() (+4 more)

### Community 139 - "cloudflare-cutover.sh"
Cohesion: 0.73
Nodes (5): cf_api(), require_env(), set_zone_setting(), cloudflare-cutover.sh script, upsert_a_record()

### Community 140 - "qa-visual-installer.mjs"
Cohesion: 0.33
Nodes (5): overflowRows, PAGES, report, THEMES, WIDTHS

### Community 141 - "CLAUDE.md - Auctorio Agent Guide"
Cohesion: 0.17
Nodes (11): [ARCHITECT], Behavioral Rules, Build & Test Commands, CLAUDE.md - Auctorio Agent Guide, [DEVELOPER], graphify, Managed engineering policy, Project Context (+3 more)

### Community 142 - "studio-ssr.test.ts"
Cohesion: 0.47
Nodes (4): getFreePort(), MockBackend, startStudioServer(), waitForServer()

### Community 143 - "intelligence-report.ts"
Cohesion: 0.13
...
### Community 144 - "editorial-plan.ts"
Cohesion: 0.06
Nodes (44): buildPromptV2(), CHANNELS, renderPlanningContext(), enqueueEditorialPlanGeneration(), executeEditorialPlanGeneration(), generateEditorialPlan(), GenerateEditorialPlanInput, isNearDuplicateTitle() (+36 more)

### Community 145 - "site-value.ts"
Cohesion: 0.19
Nodes (12): EnrichmentValue, localizedTitle(), MOVIE_TV_VALUE_PRESET, readStringList(), resolveDefinitions(), resolveSiteValueBlocks(), SiteValueBlockDefinition, SiteValueConfig (+4 more)

### Community 146 - "smoke-editorial.cjs"
Cohesion: 0.60
Nodes (4): call(), crypto, main(), signedHeaders()

### Community 147 - "AGENTS.md - Auctorio AI Agents"
Cohesion: 0.40
Nodes (4): AGENTS.md - Auctorio AI Agents, Available Agent Roles, Managed engineering policy, Optimization Policy

### Community 148 - "getImageSitemapEntries"
Cohesion: 0.29
...
### Community 156 - "audit.ts"
Cohesion: 0.25
Nodes (7): main(), MOVIE_SOURCES, prisma, TRUNCATE_TABLES, verifyTruncateSafety(), AuditActorType, prisma

### Community 157 - "production"
Cohesion: 0.25
Nodes (8): serve, production, budgets, buildTarget, outputHashing, builder, configurations, defaultConfiguration

### Community 160 - "AppToastHostComponent"
Cohesion: 0.40
Nodes (3): AppToastHostComponent, Component, ToastItem

### Community 166 - "AGENTS.md - Auctorio AI Agents"
Cohesion: 0.40
Nodes (4): AGENTS.md - Auctorio AI Agents, Available Agent Roles, Managed engineering policy, Optimization Policy

### Community 169 - "architect"
Cohesion: 0.40
Nodes (5): extract-i18n, test, builder, architect, builder

### Community 172 - "views.ts"
Cohesion: 0.11
...
### Community 173 - "cost-policy.ts"
Cohesion: 0.33
Nodes (7): checkCostPolicy(), CostPolicyInput, CostPolicyResult, startOfDayUtc(), startOfMonthUtc(), toNumber(), costPolicyAdapter

### Community 174 - "Auctorio Source Registry Architecture (Phase 2)"
Cohesion: 0.22
...
### Community 206 - "ai-judge.ts"
Cohesion: 0.19
Nodes (8): AiJudge, AiJudgeConfig, createAiJudge(), DisabledAiJudge, getAiJudge(), JudgeInput, JudgeVerdict, TextAiJudge

### Community 207 - "planner.ts"
Cohesion: 0.10
Nodes (35): runAutomationWorker(), assertSafeAutomationPolicy(), AUTOMATION_DEFAULTS, AutomationStatus, countChannelPublicationsToday(), EditorialSlot, generateEditorialSlots(), getAutomationStatus() (+27 more)

### Community 208 - "site-editorial-profile.ts"
Cohesion: 0.22
Nodes (13): BuildProfileInput, buildSiteEditorialProfile(), ContentGap, getSiteEditorialProfile(), prisma, readEditorialDescription(), readProfileTopicArray(), readStringArray() (+5 more)

### Community 209 - "discovery-planner.ts"
Cohesion: 0.29
...
### Community 210 - "browser.ts"
Cohesion: 0.50
Nodes (3): BrowserFetchOptions, BrowserHandle, BrowserPage

### Community 212 - "structuredEvent"
Cohesion: 0.11
Nodes (34): decryptSecret(), encryptionKey(), encryptSecret(), generateOAuthState(), generatePkceVerifier(), hmacHex(), sha256Hex(), tryDecryptSecret() (+26 more)

### Community 214 - "sha256"
Cohesion: 0.06
Nodes (38): cleanupFixture(), clusterFor(), createFixture(), Fixture, ingest(), line(), main(), makeItem() (+30 more)

## Knowledge Gaps
- **1344 isolated node(s):** `$schema`, `version`, `packageManager`, `analytics`, `newProjectRoot` (+1339 more)
...
- **Why does `getPrismaClient()` connect `getPrismaClient` to `studio/auth.ts`, `routes.ts`, `publication.ts`, `operations.ts`, `web-discovery.ts`, `routes-editorial.ts`, `intelligence-phase3.test.ts`, `site-relevance.ts`, `intelligence-report.ts`, `editorial-plan.ts`, `routes-connectors.ts`, `enrichment-providers.ts`, `dependencies.ts`, `pipeline.ts`, `audit.ts`, `scraping/index.ts`, `loginStudioAccountWithPassword`, `cost-policy.ts`, `http-utils.ts`, `notifications.ts`, `editorial-engine.test.ts`, `provider-cache.ts`, `worker-publishing.ts`, `profile.ts`, `source-registry.test.ts`, `social.ts`, `movie-tv/plugin.ts`, `planner.ts`, `site-editorial-profile.ts`, `discovery-planner.ts`, `orchestrator.ts`, `content-intelligence.test.ts`, `structuredEvent`, `editorial.ts`, `sha256`, `sources.ts`, `repository.ts`, `deduplication.ts`, `source-registry.ts`, `cleanup-seeded-connections.ts`, `provision-linked-tenants.ts`?**
  _High betweenness centrality (0.039) - this node is a cross-community bridge._
- **Why does `getNumberEnv()` connect `getNumberEnv` to `publication.ts`, `operations.ts`, `web-discovery.ts`, `structured.ts`, `getPrismaClient`, `pipeline.ts`, `topic-controller.ts`, `api.ts`, `scraping/index.ts`, `publishers.ts`, `cost-policy.ts`, `http-utils.ts`, `fetchWithTimeout`, `social-publishers.ts`, `adapters/http.ts`, `profile.ts`, `image.ts`, `source-registry.test.ts`, `FirecrawlWebIntelligenceProvider`, `planner.ts`, `sources.ts`, `getEnv`, `connectors/verification.ts`?**
  _High betweenness centrality (0.035) - this node is a cross-community bridge._
- **Why does `getEnv()` connect `getEnv` to `studio/auth.ts`, `getNumberEnv`, `routes.ts`, `publication.ts`, `operations.ts`, `web-discovery.ts`, `structured.ts`, `connectors/registry.ts`, `getPrismaClient`, `enrichment-providers.ts`, `pipeline.ts`, `api.ts`, `scraping/index.ts`, `publishers.ts`, `loginStudioAccountWithPassword`, `http-utils.ts`, `fetchWithTimeout`, `social-publishers.ts`, `worker-publishing.ts`, `adapters/http.ts`, `image.ts`, `tmdb.ts`, `FirecrawlWebIntelligenceProvider`, `planner.ts`, `structuredEvent`, `sources.ts`?**
...
- **Should `studio.models.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.029424398625429553 - nodes in this community are weakly interconnected._
